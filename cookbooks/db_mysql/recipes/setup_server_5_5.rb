...
log "  Setting DB MariaDB version to #{version}"

# Set MariaDB 5.5 specific node variables in this recipe.
#
...
# For Red Hat and similar distributions, the MariaDB distribution is divided into a
...
log "  Using MariaDB service name: #{node[:db_mysql][:service_name]}"
